...
public class ErrorWindow extends javax.swing.JFrame {
    ...
    public ErrorWindow(String err) {
        ...
        this.passedError = err;
        initComponents();
        ErrorLog.setText(passedError);
    }
    ...
    private void initComponents() {
        ...
        ErrorLog = new java.awt.Label();
        ConfirmButton = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        ErrorLog.setAlignment(java.awt.Label.CENTER);
        ErrorLog.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ErrorLog.setName("errorLog"); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(ErrorLog, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ErrorWindow(null).setVisible(true);
            }
        });
    }
    ...
    private java.awt.Label ErrorLog;
